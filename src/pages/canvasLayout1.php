...
<head>
    ...
    <style>
        ...
        #videoContainer {
            height: 400px; /* Reduced from 637px to fit within viewport */
            width: 100%;
            border-radius: 12px;
        }
        ...
        .camera-settings, .filter-section {
            padding: 0.6rem;
        }

        .settings-title, .filter-title {
            font-size: 0.8rem;
            margin-bottom: 0.5rem;
        }
        ...
        #startBtn, #captureAllBtn, #doneBtn {
            padding: 8px 20px;
            font-size: 0.9rem;
            border-radius: 15px;
        }
        ...
        @media (max-width: 1024px) {
            ...
            .photo-preview-container, .controls-container {
                max-width: 25%;
            }
            #videoContainer {
                height: 350px;
        ...
        @media (max-width: 768px) {
            ...
            .photo-preview-container, .camera-container, .controls-container {
                max-width: 100%;
            }
            #videoContainer {
                height: 300px;
