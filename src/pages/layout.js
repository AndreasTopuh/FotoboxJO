document.addEventListener('DOMContentLoaded', () => { 
    ...
    if (layoutBtn1) {
        layoutBtn1.addEventListener('click', (e) => {
            e.preventDefault()
            window.location.href = '/src/pages/canvasLayout1.php' // Layout 1 - 2 photos
        })
    }
    ...
    if (layoutBtn2) {
        layoutBtn2.addEventListener('click', (e) => {
            e.preventDefault()
            window.location.href = '/src/pages/canvasLayout2.php' // Layout 2 - 4 photos
        })
    }
    ...
    if (layoutBtn3) {
        layoutBtn3.addEventListener('click', (e) => {
            e.preventDefault()
            window.location.href = '/src/pages/canvasLayout3.php' // Layout 3 - 6 photos
        })
    }
    ...
    if(layoutBtn4) {
        layoutBtn4.addEventListener('click', (e) => {
            e.preventDefault()
            window.location.href = '/src/pages/canvasLayout4.php' // Layout 4 - 8 photos
        })
    }
    ...
    if(layoutBtn5) {
        layoutBtn5.addEventListener('click', (e) => {
            e.preventDefault()
            window.location.href = '/src/pages/canvasLayout5.php' // Layout 5 - 6 photos
        })
    }
    ...
    if(layoutBtn6) {
        layoutBtn6.addEventListener('click', (e) => {
            e.preventDefault()
            window.location.href = '/src/pages/canvasLayout6.php' // Layout 6 - 4 photos
        })
    }
    ...
    if (canvasBtn) {
        canvasBtn.addEventListener('click', (e) => {
            e.preventDefault()
            window.location.href = '/src/pages/canvas.php' // Original canvas - 1 photo
        })
    }
    ...
    if (canvas2Btn) {
        canvas2Btn.addEventListener('click', (e) => {
            e.preventDefault()
            window.location.href = '/src/pages/canvas2.php' // Canvas 2 - 2 photos
        })
    }
    ...
    if (canvas4Btn) {
        canvas4Btn.addEventListener('click', (e) => {
            e.preventDefault()
            window.location.href = '/src/pages/canvas4.php' // Canvas 4 - 4 photos
        })
    }
    ...
    if (canvas6Btn) {
        canvas6Btn.addEventListener('click', (e) => {
            e.preventDefault()
            window.location.href = '/src/pages/canvas6.php' // Canvas 6 - 6 photos
        })
    }
