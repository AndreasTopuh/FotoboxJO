...
<head>
    ...
    <style>
        ...
        .customize-action-btn.disabled:hover,
        .customize-action-btn:disabled:hover {
...
<body>
    ...
    <main class="customize-content-wrapper">
        ...
        <section class="customize-left-section">
            ...
            <!-- Stickers (Dynamic from Database - Layout 5 specific) -->
            <div class="customize-options-group">
                ...
                <div id="dynamicStickersContainer" class="customize-buttons-grid stickers-grid">
                    ...
                    <div class="loading-placeholder">Loading layout 5 stickers...</div>
                </div>
            </div>

            <!-- Frame & Sticker Combo (Dynamic from Database - Layout 5 specific) -->
            <div class="customize-options-group">
                ...
                <div id="dynamicFrameStickerContainer" class="customize-buttons-grid stickers-grid">
                    ...
                    <div class="loading-placeholder">Loading layout 5 frame & sticker combos...</div>
                </div>
            </div>
