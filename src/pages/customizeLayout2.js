        ...
        if (downloadBtn) {
            downloadBtn.addEventListener('click', () => {
                if (finalCanvas) {
                    ...
                    link.download = 'fotoboks-layout2.png';
            ...
            storedImages.slice(0, imagesToProcess).forEach((imageData, index) => {
                ...
                img.onload = function () {
                    ...
                    const positions = [
                        ...
                        { x: leftColumnX, y: marginTop + photoHeight + spacing, width: photoWidth, height: photoHeight }, // Foto 2: x: 62, y: 120 + 639 + 37 = 796
                        // Kolom kanan: Foto 3, 4
                        { x: rightColumnX, y: marginTop, width: photoWidth, height: photoHeight }, // Foto 3: x: 661, y: 120
                        { x: rightColumnX, y: marginTop + photoHeight + spacing, width: photoWidth, height: photoHeight } // Foto 4: x: 661, y: 120 + 639 + 37 = 796
                    ];
