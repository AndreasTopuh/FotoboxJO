...
<head>
    ...
    <meta name="description"
        content="Customize your Layout 3 photobooth photos. Add frames, stickers, and text to your 6-photo grid.">
    <meta name="keywords"
        content="photobooth customization, layout 3 editing, photo frames, photo stickers, photo grid editing">
    <title>Photobooth | Customize Layout 3</title>
    <link rel="canonical" href="https://www.gofotobox.online">
    <meta property="og:title" content="Photobooth | Customize Layout 3">
...
<body>
    <main id="main-section">
        <section id="choose-layout">
            <h1 class="custom-heading layout-heading">Customize Your Layout 3 Photos</h1>
            <p class="layout-subtext">6-photo grid layout: Perfect for photo collages!</p>
                ...
                <nav id="new-navbar">
                    ...
                    <div id="nav-links">
                        <ul>
                            ...
                            <li><a href="canvasLayout3.php">Layout 3</a></li>
                            <li><a href="customizeLayout3.php" class="current-nav">Customize</a></li>
                        </ul>
                    </div>
