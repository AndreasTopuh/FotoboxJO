...
DOWNLOAD_QUALITY: 1.05,      // 95% - hampir lossless
    ...
    // Asset Loading - Layout 4 specific
    async function loadAssetsFromDatabase() {
        ...
        try {
            ...
            // Load layout 4 specific stickers
            if (stickersData.success && stickersData.data) {
                loadDynamicStickers(stickersData.data);
            }

            // Load layout 4 specific frame & sticker combos
            if (comboData.success && comboData.data) {
                loadDynamicFrameStickerCombos(comboData.data);
            }

            console.log(`✅ Loaded Layout 4 assets successfully`);
        } catch (error) {
            console.error('❌ Error loading Layout 4 assets from database:', error);
        }
    }
    ...
    // Dynamic sticker loading (layout 4 specific)
    function loadDynamicStickers(stickers) {
        ...
        console.log(`✅ Created ${stickers.length} dynamic sticker controls for Layout 4`);
    }

    // Dynamic frame & sticker combo loading (layout 4 specific)
    function loadDynamicFrameStickerCombos(combos) {
        ...
        console.log(`✅ Created ${combos.length} dynamic frame & sticker combo controls for Layout 4`);
    }

    // Initialize Layout 4 assets on page load
