document.addEventListener('DOMContentLoaded', () => {
    ...
    async function storeImageArray() {
        ...
        try {
            console.log('⚡ Starting FAST photo compression for 8 photos...');
            ...
            console.log('💾 Saving 8 compressed photos to server session...');
            ...
            if (data.success) {
                console.log(`🎉 SUCCESS! 8 photos saved in ${Date.now() - startTime}ms`);
