        ...
        try {
            ...
            if (data.success) {
                ...
                try {
                    ...
                    localStorage.setItem('fotobox_layout', 'layout1');
                    console.log('💾 Original and session photos backed up');
                    console.log(`📊 Originals: ${originalPhotos.length} photos, Session: ${sessionPhotos.length} photos`);
                } catch (e) {
