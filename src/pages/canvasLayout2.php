...
<head>
    ...
    <meta name="keywords" content="photobooth, photo layout, photo grid, online photobooth, layout 2, 4 photos">
...
<body>
    <main id="main-section">
        <section id="choose-layout">
            <h1 class="custom-heading layout-heading">Layout 2 - 4 Photos</h1>
                ...
                <nav id="new-navbar">
                    ...
                    <div id="nav-links">
                        <ul>
                            ...
                            <li><a href="canvasLayout2.php" class="current-nav">Layout 2</a></li>
                        </ul>
                    </div>
