document.addEventListener('DOMContentLoaded', () => {
    ...
    async function startPhotobooth() {
        ...
        for (let i = 0; i < 6; i++) { // Changed to 2 photos
        ...
        // Reset buttons
        if (images.length === 6) { // Changed to 2 photos
        ...
        images.forEach((imgData, index) => {
            ...
            img.onload = () => {
                ...
                if (loadedImages === 6) {
                    ...
                    sessionStorage.setItem('photoArray5', JSON.stringify(storedImages)); 
                    console.log("6 images stored in sessionStorage with key 'photoArray5'!");
                    console.log("Redirecting to customizeLayout5.php...");
                    alert("About to redirect to customizeLayout5.php");
                    window.location.href = 'customizeLayout5.php'; // Redirect to Layout5 customize page
                }
            };
        });
    }
    ...
    if (doneBtn) {
        doneBtn.addEventListener('click', () => {
            console.log("Done button clicked, calling storeImageArray()");
            storeImageArray();
        });
    }
